    ...
    async def _generate_pdf(self, research_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # Author and affiliation (placeholder - can be customized)
                story.append(Paragraph("Generated by MIT Research Paper Generator", author_style))
                story.append(Paragraph("Artificial Intelligence Research Lab", affiliation_style))
                ...
                story.append(Spacer(1, 24))
                from datetime import datetime
                footer_text = f"Generated on {datetime.now().strftime('%B %d, %Y')} by MIT Research Paper Generator"
